...
public class PowerCore extends BlockContainer
{
    ...
    public PowerCore(boolean p_i45407_1_)
    {
        super(Material.rock);
    ...
    {
        return Item.getItemFromBlock(Construct.powerCore);
    }
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon("construct:powerCore");
    ...
    public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
        ...
        {
            PowerCoreEntity pce = (PowerCoreEntity)p_149727_1_.getTileEntity(p_149727_2_, p_149727_3_, p_149727_4_);

            if (pce != null)
            {
                p_149727_5_.func_146100_a(pce);
            }
    ...
    public static void updateFurnaceBlockState(boolean p_149931_0_, World p_149931_1_, int p_149931_2_, int p_149931_3_, int p_149931_4_)
    {
        ...
        if (p_149931_0_)
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, Construct.powerCore);
        }
        else
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, Construct.powerCore);
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            ((PowerCoreEntity)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).setDisplayName(p_149689_6_.getDisplayName());
        }
    }
    ...
    public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        if (!field_149934_M)
        {
            PowerCoreEntity pce = (PowerCoreEntity)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);

            if (pce != null)
            {
                for (int i1 = 0; i1 < pce.getSizeInventory(); ++i1)
                {
                    ItemStack itemstack = pce.getStackInSlot(i1);
